...
<?php $__env->startSection('title', 'Add New Book - Admin'); ?>
                    ...
                    <form method="POST" action="<?php echo e(route('admin.books.store')); ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="availability" name="availability" required>
                                <option value="1" <?php echo e(old('availability', 1) == 1 ? 'selected' : ''); ?>>Available</option>
                                <option value="0" <?php echo e(old('availability') == 0 ? 'selected' : ''); ?>>Out of Stock</option>
                            </select>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Siddharth Soni\online-book-store\resources\views/admin/books/create.blade.php ENDPATH**/ ?>